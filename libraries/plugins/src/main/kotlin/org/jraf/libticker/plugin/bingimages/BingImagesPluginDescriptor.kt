...
object BingImagesPluginDescriptor {
    const val KEY_PERIOD = "period"
    const val KEY_QUEUE_SIZE = "queueSize"

    val DESCRIPTOR = PluginDescriptor(
        className = BingImagesPlugin::class.java.name,
...
class BingImagesPluginDescriptorProvider : PluginDescriptorProvider {
    override val pluginDescriptor = BingImagesPluginDescriptor.DESCRIPTOR
}
